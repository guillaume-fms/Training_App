...
public interface Business {
	 ...
	 * - puis va ajouter autant de commandes minifiées associées : orderTraining -> idOrderTraining + idTraining + Quantity + Price + idOrder
	...
	/**
	 * méthode qui renvoi toutes les formations de la table t_trainings en bdd
